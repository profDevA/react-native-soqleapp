...
import { Text, Clipboard, StyleSheet, TouchableWithoutFeedback, View, ViewPropTypes, ActivityIndicator, Image } from 'react-native';
import QuickReplies from 'react-native-gifted-chat/lib/QuickReplies';
import { MessageText, MessageImage, MessageVideo, Time } from 'react-native-gifted-chat';
...
//       console.log("bubble getDerivedStateFromProps ", props.currentMessage)
//     if (props.currentMessage.status) {
//       console.log("getDerivedStateFromProps updating status")
//         state.messageStatus=props.currentMessage.status;
//     }
//     return null;
// }

    componentDidMount() {
        this.setState({messageStatus: this.props.currentMessage.status});
    }

    // componentWillMount() {
    //   console.log("checking componentDidMount ", this.props.currentMessage.status)
    //
    //     this.setState({messageStatus: this.props.currentMessage.status});
    // }

    componentWillReceiveProps(nextProps) {
        if (nextProps.currentMessage.status) {
            this.setState({messageStatus: nextProps.currentMessage.status});
        } else {
